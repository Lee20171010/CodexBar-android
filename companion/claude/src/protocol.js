...
export const SNAPSHOT_SOURCE = 'claude-cli-terminal';
export const AUTH_KEY_CONTEXT = 'codexbar-claude-auth-v1';
export const ENCRYPTION_KEY_CONTEXT = 'codexbar-claude-encryption-v1';
